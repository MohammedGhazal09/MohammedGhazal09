...
##  Technical Skills
- **Frontend:** React.js, Angular.js, Next.js, TypeScript, HTML5, CSS, JavaScript (ES6+), Tailwind CSS
- **Backend:** Node.js, Express.js, PHP, Laravel, Python, Django, REST APIs, JWT Authentication  
- **Database:** MongoDB, MySQL, Mongoose
- **Tools:** Git, GitHub, Azure, VS Code, Postman, npm, Vercel
